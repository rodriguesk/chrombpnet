...
def generate_bigwig(input_bam_file, input_fragment_file, input_tagalign_file, output_prefix, genome_fasta_file, bsort, tmpdir, no_st, chrom_sizes_file, plus_shift_delta, minus_shift_delta):
    ...
    bw_path = "/oak/stanford/groups/smontgom/kameronr/methylseq/JG97/novaseq/EMseq_big_20230117/usftp21.novogene.com/output_processed/GRCm39/EM_6_3_methylation_and_complement.bw"
    ...
    subprocess.run(["cp", bw_path, output_prefix + "_unstranded.bw"])
